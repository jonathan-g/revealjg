...
<!-- badges: start -->
![GitHub R package version](https://img.shields.io/github/r-package/v/jonathan-g/revealjg)
...
so `revealjg` includes an option of specifying the `reveal.js` version to 
